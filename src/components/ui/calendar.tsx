  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative has-focus:border-primary-500 border border-input shadow-xs has-focus:ring-primary-500/50 has-focus:ring-[3px] rounded-md",
