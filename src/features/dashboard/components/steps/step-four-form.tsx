      ...
      <div className="grid grid-cols-1 gap-4 @5xl:grid-cols-12">
        <div className=" gap-4 flex flex-col @5xl:sticky @5xl:top-16 @5xl:col-span-8 h-fit">
          ...
          <DashboardCard>
            ...
            <ScrollArea className="h-128 mt-4" type="always">
              {manuscript?.logs?.toReversed().map((log, index) => (
                <div
                  key={index}
                  className="mt-4 flex flex-col gap-4 bg-base-100 p-4 rounded-lg"
                >
                  <div className="flex  gap-2  flex-col @sm:flex-row @sm:items-center @sm:justify-between">
                    <div>
                      ...
                      <p className="text-sm text-base-500 ">
                        بواسطة {log.user.name} ({log.user.role})
                      </p>
                    </div>
                    <p className="text-sm text-base-500 ">
                      {formatDate({
                  ...
                  <p className="text-sm text-base-500">{log.content}</p>
                </div>
              ))}
          ...
          {/* <DashboardCard>
            <DashboardCardHeader title="تعليقت التحقق" />
            <div className="mt-4">
              <textarea
                className="w-full rounded-md border bg-gray-100 p-2 "
                rows={1}
                placeholder="اضافة التعليق"
              ></textarea>
            </div>
          </DashboardCard> */}
        </div>
          ...
          <DashboardCard>
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-col gap-2 mt-4 pt-4 border-t">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm  text-black">ملاحظات المراجعة</span>
                  <span className="text-sm text-grey-600">
                    {manuscript.pages?.length}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm  text-black">وقت المعالجة</span>
                  <span className="text-sm text-grey-600">
                    {getDaysBetween(
